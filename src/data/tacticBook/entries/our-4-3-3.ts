...
export const entriesOur433: TacticBookEntry[] = [
  {
    ...
    rating: 'vorteilhaft',
    character:
      'Meist günstiges Duell für das 4-3-3, weil wir im Zentrum oft ein 3 gegen 2 haben.',
    ourAdvantages: [
      'Überzahl im Zentrum',
      'Gute Breite über Flügel + Außenverteidiger',
      'Sechser kann Spiel lenken',
    ],
    ourDangers: [
      'Zwei gegnerische Stürmer können unseren Aufbau stressen',
      'Außenverteidiger können bei Ballverlust offen sein',
    ],
    importantZones: [
      'Sechserraum vor deren Mittelfeld',
      'Halbräume neben deren zentralen Mittelfeldspielern',
      'Raum hinter deren Außenmittelfeldspielern',
    ],
    pressing: [
      'Mittelstürmer lenkt auf eine Seite',
      'Flügel pressen Außenverteidiger',
      'Achter schieben auf deren Zentrum',
    ],
    inPossession: [
      'Achter immer wieder zwischen den Linien anbieten',
      'Außenverteidiger mutig nachschieben',
      'Seitenwechsel nutzen',
    ],
    transition: [
      'Nach Ballgewinn sofort Tiefe über Flügel suchen',
      'Nach Ballverlust Restverteidigung mit Sechser sichern',
    ],
    liveCoaching: [
      'Zentrum besetzen',
      'Flügel nicht isolieren',
      'Sechser anspielbar halten',
    ],
    adjustments: [
      'Gegen starken Druck im Aufbau auf 4-2-3-1 kippen',
    ],
  },
  {
    id: '4-3-3_vs_4-2-3-1',
