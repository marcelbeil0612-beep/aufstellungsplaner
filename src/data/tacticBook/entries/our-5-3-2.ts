...
export const entriesOur532: TacticBookEntry[] = [
  {
    ...
    rating: 'vorteilhaft',
    character:
      'Meist gutes Verteidigungsduell für uns, wenn wir den Zehnerraum kontrollieren.',
    ourAdvantages: [
      'Letzte Linie stabil',
      'Flankenverteidigung stark',
      'Zentrum kompakt',
    ],
    ourDangers: [
      'Rückraum kann offen werden',
      'Außenspieler müssen weite Wege gehen',
    ],
    importantZones: [
      'Zehnerraum',
      'Halbräume vor unserer Kette',
      'Konterraum neben deren Außenverteidigern',
    ],
    pressing: [
      'Zentrum verdichten',
      'Zehner nicht frei drehen lassen',
    ],
    inPossession: [
      'Schnell in die Tiefe',
      'Zweiter Ball wichtig',
    ],
    transition: [
      'Nach Ballgewinn sofort vertikal',
      'Einer sichert, einer startet',
    ],
    liveCoaching: [
      'Block eng halten',
      'Nicht nur tief verteidigen, auch entlasten',
    ],
    adjustments: [
  ...
  },
  {
    ...
    ourAdvantages: [
      'Fünferkette sichert gut gegen drei Angreifer.',
      'Zwei Spitzen können Innenverteidiger früh anlaufen.',
    ],
    ourDangers: [
      'Flügelüberzahl gegen unsere Wingbacks.',
      'Räume hinter aufrückenden Wingbacks.',
    ],
    importantZones: [
      'Außenbahnen neben den Wingbacks.',
      'Halbräume vor den äußeren Innenverteidigern.',
    ],
    pressing: [
      'Spitzen lenken auf eine Seite und schließen den Sechser.',
      'Wingback springt erst bei schlechtem ersten Kontakt.',
    ],
    inPossession: [
      'Nach Ballzirkulation schnell diagonal auf den freien Wingback.',
  ...
  },
  {
    ...
    ourAdvantages: [
      'Drei zentrale Mittelfeldspieler gegen zwei.',
      'Drei Innenverteidiger kontrollieren ihre zwei Spitzen.',
    ],
    ourDangers: [
      'Doppeln auf den Außenbahnen.',
      'Flanken auf den ballfernen Pfosten.',
    ],
    importantZones: [
      'Zentrum vor ihrer Doppelsechs.',
      'Ballferner Raum hinter dem Wingback.',
    ],
    pressing: [
    ...
    transition: [
      'Nach Ballgewinn sofort auf die abkippende Spitze.',
  ...
  },
  {
    ...
    ourAdvantages: [
      ...
      'Fünferkette gibt Absicherung gegen zwei Spitzen.',
    ],
    ourDangers: [
      'Ihre Raute kann unser Zentrum überladen.',
      'Zehner findet Raum vor unserer Abwehr.',
    ],
    importantZones: [
      'Raum vor unserem zentralen Innenverteidiger.',
      'Außenbahnen hinter ihren Halbspielern.',
    ],
    pressing: [
