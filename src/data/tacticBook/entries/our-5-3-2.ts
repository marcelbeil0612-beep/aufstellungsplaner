...
export const entriesOur532: TacticBookEntry[] = [
    ...
    phases: {
      ownPossession: {
        spaces: [
          ...
          'Unsere Schienenspieler brauchen nach Ballbesitzphasen klare Anschlussräume, dürfen aber nicht beide gleichzeitig hoch stehen.',
        ...
        advantages: [
          ...
          'Unsere Schienenspieler können nach Verlagerungen aus tiefer Position Tempo gegen ihre Außenverteidiger aufnehmen.',
        ...
        dangers: [
          ...
          'Bei Ballverlusten mit hohen Schienenspieler wird der Raum neben unseren Halbverteidigern offen.',
        ],
        keyActions: [
          'Eine Spitze bindet tief, die andere lässt für den nachrückenden Achter klatschen.',
          'Schienenspieler nach Ballverlagerung sofort in den Raum neben ihrem Außenverteidiger schicken.',
      ...
      afterLoss: {
        spaces: [
          ...
          'Die Außenbahn hinter unserem Schienenspieler ist ihr erster Umschaltraum.',
        ],
        advantages: [
        ...
        dangers: [
          ...
          'Außenspieler müssen lange Wege zurückgehen, besonders nach eigenen Angriffen über Schienenspieler.',
        ],
        keyActions: [
          ...
          'Ballnaher Schienenspieler sprintet zurück in die Kette, wenn der Gegenpressingzugriff fehlt.',
      ...
      oppPossession: {
        spaces: [
          ...
          'Außenbahnen werden kontrolliert, wenn Schienenspieler und Halbverteidiger klare Übergaben haben.',
        ...
        dangers: [
          ...
          'Ihre Flügelspieler können unsere Schienenspieler tief binden und Rückraumläufe vorbereiten.',
        ...
        keyActions: [
          ...
          'Schienenspieler stellt den Flügelspieler, Halbverteidiger sichert den Halbraum dahinter.',
      ...
      afterGain: {
        spaces: [
          ...
          'Der ballferne Schienenspieler kann frei werden, wenn ihr Gegenpressing zur Ballseite kippt.',
        ],
        advantages: [
          ...
          'Schienenspieler können aus der Tiefe mit Tempo in freie Flügelräume starten.',
        ],
        dangers: [
        ...
        keyActions: [
          ...
          'Ballferner Schienenspieler startet erst, wenn der erste Pass gesichert ist.',
  ...
  },
  {
    ...
    rating: 'unangenehm',
    character:
      'Unangenehmes Duell, weil ihr balldominantes 4-3-3 uns mit Flügelbreite tief festsetzt und wir kaum Entlastung finden. Schlüsselvorteil ist unsere Stabilität gegen ihre erste Linie mit zwei Konterspitzen, Schlüsselrisiko sind ihre Flügel, wenn sie unsere Schienenspieler dauerhaft binden.',
    phases: {
      ownPossession: {
        spaces: [
          'Der Raum hinter ihren Außenverteidigern ist unser wichtigster Tiefenraum.',
          'Der ballferne Schienenspieler wird frei, wenn ihr 4-3-3 mit Flügel und Achter zur Ballseite presst.',
          ...
          'Räume hinter unseren Schienenspieler bleiben kritisch, sobald beide Seiten gleichzeitig hochschieben.',
        ],
        advantages: [
          'Zwei Spitzen können ihre Innenverteidiger binden und direkte Tiefenläufe anbieten.',
          'Nach Ballzirkulation können wir diagonal auf den freien Schienenspieler verlagern.',
          'Unsere Dreierkette gibt gegen ihre erste Pressinglinie stabile Absicherung.',
        ],
        dangers: [
          'Ihr Flügelpressing kann unsere Schienenspieler tief festnageln und uns im Aufbau nach außen drücken.',
          'Wenn die Spitzen keine Ablage sichern, kommen lange Bälle schnell zurück.',
          'Bei zu hohen Schienenspieler entstehen Räume hinter ihnen für ihre Flügelstürmer.',
          'Ihre Achter können nach Ballverlusten sofort in unsere Halbräume springen.',
        ],
        keyActions: [
          'Nach Ballzirkulation schnell diagonal auf den freien Schienenspieler spielen.',
          'Spitzen besetzen Tiefe zwischen Innen- und Außenverteidiger.',
          'Eine Spitze kommt entgegen, die andere hält die Tiefe.',
          'Ballnaher Achter bietet sich unter dem Schienenspieler für Rückpass und zweiten Ball an.',
          'Ballferner Schienenspieler startet erst, wenn der erste Pass aus dem Druck gesichert ist.',
        ],
      },
      afterLoss: {
        spaces: [
          'Der Halbraum vor dem äußeren Innenverteidiger muss sofort geschlossen werden.',
          'Die Außenbahn hinter unserem Schienenspieler ist ihre erste Umschaltspur.',
        ...
        advantages: [
          ...
          'Ein Halbverteidiger kann absichern, während der Schienenspieler zurück in die Kette sprintet.',
        ],
        dangers: [
          'Flügelüberzahl gegen unsere Schienenspieler entsteht sofort, wenn der ballnahe Achter zu spät hilft.',
          'Räume hinter aufrückenden Schienenspieler werden direkt von ihren Flügelstürmern attackiert.',
        ...
        keyActions: [
          ...
          'Schienenspieler sprintet zurück, wenn der erste Gegenpressingzugriff fehlt.',
      ...
      oppPossession: {
        spaces: [
          'Außenbahnen neben den Schienenspieler sind die Hauptkonfliktzone gegen ihre Flügelstürmer.',
          'Halbräume vor den äußeren Innenverteidigern müssen zwischen Achter, Schienenspieler und Halbverteidiger übergeben werden.',
        ...
        dangers: [
          'Ihre Flügel können unsere Schienenspieler dauerhaft binden und Flanken- oder Rückpassdruck erzeugen.',
          'Ihre Außenverteidiger können Überzahl herstellen, wenn unser Achter nicht mit auf die Seite kommt.',
          'Schienenspieler springt zu früh heraus und öffnet dann den Raum hinter sich.',
        ...
        keyActions: [
          ...
          'Schienenspieler springt erst bei schlechtem erstem Kontakt.',
          'Ballnaher Achter hilft konsequent auf dem Flügel.',
          'Eine Spitze lässt sich situativ auf ihren Sechser fallen.',
          'Halbverteidiger sichert den Raum hinter dem Schienenspieler, ohne den Innenverteidiger herauszuziehen.',
        ],
      },
      afterGain: {
        spaces: [
          ...
          'Der ballferne Schienenspieler kann nach Verlagerung frei in Tempo kommen.',
        ...
        advantages: [
          ...
          'Schienenspieler können aus der Tiefe in freie Flügelräume starten.',
          'Unsere stabile letzte Linie erlaubt klare Konterabsicherung mit einem zurückbleibenden Schienenspieler.',
        ],
        dangers: [
          'Ein zu langer Ball ohne Anschluss bringt uns direkt wieder in tiefe Verteidigung.',
          'Wenn beide Schienenspieler gleichzeitig starten, fehlt die Breite in der Restverteidigung.',
        ...
        keyActions: [
          ...
          'Erster Pass sucht eine Spitze oder den ballnah startenden Schienenspieler.',
          ...
          'Ballferner Schienenspieler bleibt zunächst tiefer, bis der Konter kontrolliert ist.',
        ],
      },
    },
    liveCoaching: [
    ...
    adjustments: [
      ...
      'Bei eigenem Ballbesitz einen Schienenspieler bewusst tiefer halten, damit die Gegenseite mutiger starten kann.',
    ],
  },
  {
    id: '5-3-2_vs_4-4-2',
    ...
    phases: {
      ownPossession: {
        spaces: [
          ...
          'Schienenspieler können früh hochschieben und ihre Außenspieler nach hinten binden.',
          'Der ballferne Raum hinter ihrem Außenverteidiger wird nach Verlagerungen interessant.',
          'Die Restverteidigung hinter unseren Schienenspieler muss gegen ihre zwei Spitzen und direkte Flügelbälle stabil bleiben.',
        ],
        advantages: [
        ...
        dangers: [
          ...
          'Ein Ballverlust nach hohem Schienenspieler öffnet den direkten Pass auf ihre Außenspieler.',
        ...
        keyActions: [
          ...
          'Schienenspieler früh hochschieben und ihre Außenspieler binden.',
          'Eine Spitze kippt ab, um den ersten Ballkontakt zwischen den Linien zu sichern.',
      ...
      afterLoss: {
        spaces: [
          ...
          'Der ballferne Raum hinter unserem Schienenspieler ist nach Flügelangriffen besonders gefährlich.',
        ...
        dangers: [
          'Doppeln auf den Außenbahnen kann unseren Schienenspieler isolieren.',
          'Flanken auf den ballfernen Pfosten werden gefährlich, wenn der ballferne Schienenspieler zu spät einrückt.',
        ...
        keyActions: [
          ...
          'Ballnaher Schienenspieler stellt den Außenspieler, Halbverteidiger sichert dahinter.',
          'Ballferner Schienenspieler rückt früh zum zweiten Pfosten ein.',
      ...
      oppPossession: {
        spaces: [
          ...
          'Außenbahnen werden kritisch, wenn ihr Außenverteidiger und Außenspieler gegen unseren Schienenspieler doppeln.',
        ...
        advantages: [
          ...
          'Unsere Fünferkette kann Flanken aufnehmen, wenn Schienenspieler und Halbverteidiger klare Übergaben haben.',
        ],
        dangers: [
          'Breite Angriffe mit Außenverteidiger und Außenspieler können unseren Schienenspieler tief binden.',
        ...
        keyActions: [
          ...
          'Zentraler Mittelfeldspieler attackiert ihre Doppelsechs aggressiv.',
          'Ballnaher Achter hilft dem Schienenspieler, sobald ihre Seite doppelt.',
          'Ballferner Schienenspieler kontrolliert den zweiten Pfosten vor dem Außenspieler.',
      ...
      afterGain: {
        spaces: [
          ...
          'Der ballferne Schienenspieler hat nach Ballgewinn häufig freie Bahn für die Verlagerung.',
        ...
        advantages: [
          ...
          'Schienenspieler können nach Ballgewinn direkt gegen ihre zurücklaufenden Außenspieler Tempo aufnehmen.',
        ],
        dangers: [
          'Ein unkontrollierter langer Ball auf beide Spitzen gibt ihre Viererkette wieder Zugriff.',
          'Wenn der ballnahe Schienenspieler sofort startet, kann der Rückkonter über seine Seite offen bleiben.',
        ...
        keyActions: [
          ...
          'Ballferner Schienenspieler startet in die Breite, sobald der erste Pass gesichert ist.',
  ...
  },
  {
    ...
    rating: 'vorteilhaft',
    character:
      'Vorteilhaftes Duell, weil unsere Fünferkette das Zentrum gegen ihre Raute verdichtet und unsere Schienenspieler die fehlende Breite der engen Raute bestrafen. Schlüsselraum sind die Außenbahnen über unsere Schienenspieler, Schlüsselrisiko ist ihre zentrale Bindung, wenn wir nach Ballverlust nicht sofort gegen die Raute einrücken.',
    phases: {
      ownPossession: {
        spaces: [
          'Außenbahnen hinter ihren Halbspielern sind der freie Raum gegen die enge Raute.',
          'Unsere Schienenspieler haben außen oft freie Anspielstationen, wenn wir das Zentrum kurz anlocken.',
          'Rückräume vor ihrer Viererkette öffnen sich, wenn unsere Spitzen die Innenverteidiger auseinanderziehen.',
          'Der ballferne Schienenspieler kann nach Verlagerungen mit Tempo gegen ihren Außenverteidiger gehen.',
          'Das Zentrum darf nicht überladen werden, wenn ihre Raute nach Ballverlust sofort Zugriff sucht.',
        ],
        advantages: [
          'Schienenspieler haben außen oft freie Anspielstationen.',
          'Mit zwei Spitzen können wir ihre Innenverteidiger binden und Rückräume für nachrückende Mittelfeldspieler öffnen.',
          'Unsere Fünferkette gibt Absicherung gegen zwei Spitzen, wenn ein Schienenspieler hoch anschiebt.',
        ],
        dangers: [
          ...
          'Wenn beide Schienenspieler gleichzeitig hoch stehen, fehlen seitliche Sicherungen gegen direkte Außenwechsel.',
          'Zu flache Spitzen machen es ihrer Viererkette leicht, unsere Vertikalpässe zu kontrollieren.',
        ],
        keyActions: [
          'Spiel schnell nach außen auf die Schienenspieler verlagern.',
          ...
          'Achter bieten sich unter dem Schienenspieler an, damit der erste Außenpass nicht isoliert ist.',
          'Ballferner Schienenspieler bleibt zunächst tiefer, wenn die ballnahe Seite überlädt.',
        ],
      },
      afterLoss: {
        spaces: [
          ...
          'Die Außenbahn hinter unserem hochstehenden Schienenspieler bleibt offen für ihren ersten Entlastungspass.',
        ],
        advantages: [
        ...
        dangers: [
          ...
          'Wenn Schienenspieler nach Ballverlust nicht einrücken, entstehen Passwege diagonal in den Zehnerraum.',
        ],
        keyActions: [
      ...
      oppPossession: {
        ...
        advantages: [
          ...
          'Unsere Schienenspieler können außen hoch bleiben, wenn der ballnahe Achter den Halbraum sichert.',
        ],
        dangers: [
        ...
        keyActions: [
          ...
          'Ballnaher Schienenspieler hält Kontakt zum Außenverteidiger, ohne den Halbraum zu öffnen.',
          'Achter übergeben Halbspieler klar an Sechs oder Schienenspieler, statt beide dem Ball zu folgen.',
        ],
      },
      afterGain: {
        spaces: [
          'Die Außenbahn ist nach Ballgewinn sofort frei, weil ihre Raute zentral verdichtet.',
          'Der ballferne Schienenspieler kann nach Verlagerung in viel Raum starten.',
        ...
        advantages: [
          ...
          'Unsere Schienenspieler haben klare freie Flügelräume gegen ihre enge Raute.',
        ...
        dangers: [
          ...
          'Wenn der Schienenspieler den ersten Ballkontakt verliert, ist der Passweg auf ihren Zehner wieder offen.',
        ...
        keyActions: [
          ...
          'Erster Pass sucht den Schienenspieler oder die abkippende Spitze neben ihrer Raute.',
          'Ballnaher Achter bietet sich unter dem Schienenspieler als Klatschoption an.',
    ...
    adjustments: [
      ...
      'Bei eigenem Druck Schienenspieler höher halten und Achter unter den Ball staffeln.',
    ],
  },
  {
    id: '5-3-2_vs_3-5-2',
    ...
    rating: 'ausgeglichen',
    character:
      'Beide Systeme spiegeln sich fast komplett. Kleine Vorteile entstehen über bessere Schienenspieler-Positionen und klarere Besetzung der zweiten Bälle.',
    phases: {
      ownPossession: {
        spaces: [
          'Schienenspieler-Duelle an der Seitenlinie entscheiden, wer die gegnerische Fünferkette nach hinten drückt.',
          ...
          'Der Rücken des ballfernen Schienenspieler ist nach schnellen Seitenwechseln angreifbar.',
        ...
        advantages: [
          ...
          'Schienenspieler können früh eingebunden werden, um den Gegner seitlich zu verschieben.',
        ],
        dangers: [
          'Lange Gleichzahl auf den Außenbahnen macht Fortschritt schwierig, wenn der Schienenspieler isoliert ist.',
          'Zu wenig Tiefe entsteht, wenn beide Spitzen gleichzeitig gebunden oder entgegenkommend sind.',
          'Ein Ballverlust nach hohem Schienenspieler öffnet sofort den spiegelgleichen Konterraum.',
          'Wenn der zentrale Innenverteidiger nicht andribbeln darf, wird der Aufbau statisch gegen ihre erste Linie.',
        ],
        keyActions: [
          'Schienenspieler früh einbinden und den Gegner seitlich verschieben.',
          ...
          'Nach Verlagerungen den ballfernen Schienenspieler direkt in den Rücken des Gegners schicken.',
        ],
      },
      afterLoss: {
        spaces: [
          'Das Zentrum muss nach Ballverlust sofort kompakt geschlossen werden.',
          'Der Rücken unseres Schienenspieler ist der erste Konterraum des Gegners.',
        ...
        advantages: [
          ...
          'Ballnahe Achter und Schienenspieler haben klare Zuordnungen in den spiegelgleichen Räumen.',
        ],
        dangers: [
          'Ihre Schienenspieler können sofort in den Rücken unserer Schienenspieler starten.',
        ...
        keyActions: [
          ...
          'Schienenspieler sprintet zurück und nimmt den gegnerischen Schienenspieler auf.',
      ...
      oppPossession: {
        spaces: [
          'Der äußere Innenverteidiger ist die Pressingseite, weil dort Schienenspieler und Achter zugeschoben werden können.',
          'Schienenspieler-Duelle an der Seitenlinie bestimmen, ob unser Block nach hinten gedrückt wird.',
          'Das Zentrum um ihre drei Mittelfeldspieler darf nicht aufdrehen.',
          'Der Raum hinter unseren Schienenspieler bleibt die gefährlichste Tiefe.',
        ...
        dangers: [
          'Lange Gleichzahl auf den Außenbahnen kann unsere Schienenspieler ermüden und tief binden.',
        ...
        keyActions: [
          ...
          'Ballnaher Achter schiebt sofort auf den zentralen Mittelfeldspieler.',
          'Schienenspieler bleibt aktiv und stellt den gegnerischen Schienenspieler bei Zuspiel.',
      ...
      afterGain: {
        spaces: [
          'Der Rücken des gegnerischen Schienenspieler ist nach Ballgewinn sofort der beste Zielraum.',
          'Der Raum hinter dem äußeren Innenverteidiger öffnet sich, wenn eine Spitze diagonal startet.',
          'Der ballferne Schienenspieler kann nach schneller Verlagerung frei werden.',
          'Zweite-Ball-Zonen im Zentrum geben Anschluss, falls der erste Tiefenpass nicht sauber ist.',
        ],
        advantages: [
          'Nach Ballgewinn können wir sofort in den Rücken des Schienenspielers spielen.',
          'Eine abkippende Spitze und eine tiefe Spitze geben klare erste und zweite Optionen.',
          'Unsere Schienenspieler können aus der Gleichzahl ausbrechen, wenn der erste Pass schnell genug kommt.',
        ],
        dangers: [
          ...
          'Ein Ballverlust im Konter öffnet denselben Raum hinter unserem Schienenspieler.',
        ],
        keyActions: [
          'Nach Ballgewinn sofort in den Rücken des Schienenspielers spielen.',
          ...
          'Schienenspieler startet in die Tiefe, sobald der erste Pass gesichert ist.',
    ...
    adjustments: [
      ...
      'Wenn die Schienenspieler isoliert sind, ballnahen Achter näher an die Seitenlinie schieben.',
      'Bei eigener Führung Schienenspieler tiefer halten und nur nach klarer Sicherung starten lassen.',
    ],
  },
  {
    id: '5-3-2_vs_3-4-3',
    ...
    rating: 'unangenehm',
    character:
      'Unangenehmes Duell, weil ihre Front drei und hohen Schienenspieler unsere Fünferkette breit auseinanderziehen und uns tief festsetzen. Schlüsselvorteil sind unsere zwei Konterspitzen, Schlüsselrisiko ist das breite Auseinanderziehen unserer Kette durch ihre Schienenspieler und Außenstürmer.',
    phases: {
      ownPossession: {
        spaces: [
          'Der Raum hinter ihren hohen Schienenspieler ist unser wichtigster Entlastungs- und Konterraum.',
          ...
          'Der ballferne Schienenspieler wird frei, wenn ihr 3-4-3 zur Ballseite schiebt.',
          'Das Zentrum vor ihrer Doppelsechs muss schnell überspielt werden, bevor ihre Front drei zurückpresst.',
          'Halbräume hinter unseren Schienenspieler bleiben kritisch, wenn wir beide Seiten gleichzeitig hochschieben.',
        ],
        advantages: [
          'Zwei Spitzen können ihre Dreierkette direkt anlaufen und im Ballbesitz zwei Zielspieler binden.',
          'Unsere Fünferkette gibt Absicherung, wenn ein Schienenspieler in freie Räume nach vorne startet.',
          'Schnelle Verlagerungen treffen ihr 3-4-3, bevor Schienenspieler und Außenstürmer zurückarbeiten.',
        ],
        dangers: [
          'Ihre Außenstürmer können unsere Schienenspieler tief binden und den Aufbau nach außen ersticken.',
          ...
          'Wenn der ballnahe Achter nicht unter dem Schienenspieler steht, fehlt die Rückpass- und Sicherungsoption.',
        ],
        keyActions: [
          'Schnell hinter ihre hohen Schienenspieler spielen.',
          ...
          'Ballnaher Achter bietet sich unter dem Schienenspieler an und sichert den Halbraum.',
          'Ein Schienenspieler startet hoch, der andere bleibt für Restverteidigung gestaffelt.',
        ],
      },
      afterLoss: {
        spaces: [
          'Der Halbraum hinter dem ballnahen Schienenspieler muss sofort geschlossen werden.',
          ...
          'Die ballferne Seite bleibt gefährlich, wenn ihr Schienenspieler früh breit bleibt.',
        ],
        advantages: [
          'Unsere Fünferkette gibt klare Absicherung gegen ihre Front drei.',
          'Ballnaher Achter und Schienenspieler können Außenstürmer gemeinsam doppeln.',
          'Drei Innenverteidiger erlauben, dass ein Halbverteidiger situativ in den Halbraum schiebt.',
        ],
        dangers: [
          'Halbräume zwischen Schienenspieler und Innenverteidiger öffnen sich bei schlechtem Gegenpressing.',
          'Außenstürmer binden unsere Schienenspieler tief und können direkte Konterläufe starten.',
        ...
        keyActions: [
          ...
          'Ballnaher Achter unterstützt den Schienenspieler gegen Außenstürmer.',
          ...
          'Ballferner Schienenspieler bleibt aufmerksam für schnelle Verlagerungen.',
        ],
      },
      oppPossession: {
        spaces: [
          'Halbräume zwischen Schienenspieler und Innenverteidiger sind die wichtigste Gefahrenzone.',
          'Der Halbraum hinter dem ballnahen Schienenspieler darf nicht von Außenstürmer und Schienenspieler gleichzeitig besetzt werden.',
          ...
          'Der ballferne Schienenspieler muss gegen Verlagerungen früh einrücken oder herausrücken können.',
        ],
        advantages: [
          'Unsere Fünferkette gibt klare Absicherung gegen ihre Front drei.',
        ...
        dangers: [
          ...
          'Außenstürmer können unsere Schienenspieler tief binden und Rückraumdruck vorbereiten.',
          'Wenn ein Schienenspieler zu früh springt, wird der Halbraum neben dem Innenverteidiger offen.',
          'Ihre Schienenspieler können nach Verlagerungen aus der Tiefe Dynamik erzeugen.',
        ],
        keyActions: [
          'Spitzen pressen die äußeren Innenverteidiger nach innen.',
          'Ballnaher Achter unterstützt den Schienenspieler gegen Außenstürmer.',
          'Schienenspieler springt nur heraus, wenn der Halbverteidiger den Halbraum sichert.',
      ...
      afterGain: {
        spaces: [
          ...
          'Der Rücken ihrer Schienenspieler ist sofort bespielbar.',
          'Schnittstellen der Dreierkette öffnen sich, wenn unsere Spitzen diagonal auseinanderlaufen.',
          'Der zentrale zweite Ball ist wichtig, falls der erste Pass hinter den Schienenspieler geblockt wird.',
        ],
        advantages: [
          ...
          'Schienenspieler können nach Balleroberung aus tiefer Position mit Tempo starten.',
        ],
        dangers: [
          ...
          'Ein erneuter Ballverlust auf außen öffnet wieder den Halbraum hinter unserem Schienenspieler.',
        ],
        keyActions: [
          'Nach Ballgewinn sofort auf die ballferne Seite verlagern.',
          'Erster Blick geht hinter ihren Schienenspieler oder auf die klatschende Spitze.',
          'Eine Spitze startet diagonal, die andere sichert den ersten Ball.',
          'Ballnaher Achter rückt für zweiten Ball und Rückpass nach.',
          'Ballferner Schienenspieler startet erst, wenn der Pass aus dem Druck gesichert ist.',
        ],
      },
    },
    liveCoaching: [
  ...
  },
  {
    ...
    rating: 'ausgeglichen',
    character:
      'Das Duell ist stark gespiegelt und oft eng. Entscheidend sind Mut im Andribbeln, Tempo über die Schienenspieler und bessere Anschlussaktionen nach zweiten Bällen.',
    phases: {
      ownPossession: {
        spaces: [
          'Die zweite-Ball-Zone vor beiden Dreierketten entscheidet, wer längere Druckphasen bekommt.',
          'Die Außenbahn hinter dem gegnerischen Schienenspieler ist nach Verlagerungen der wichtigste Raumgewinn.',
        ...
        advantages: [
          ...
          'Schienenspieler können durch Höhe und Breite die spiegelgleiche Ordnung auseinanderziehen.',
        ],
        dangers: [
          'Das Spiel kann zentral festlaufen, wenn unsere Achter auf gleicher Höhe bleiben.',
          'Zu wenig Breite entsteht, wenn Schienenspieler zu tief bleiben.',
        ...
        keyActions: [
          ...
          'Schienenspieler hoch und breit halten.',
      ...
      afterLoss: {
        spaces: [
          ...
          'Der Raum hinter unserem Schienenspieler ist die erste spiegelgleiche Konterspur.',
        ...
        dangers: [
          ...
          'Wenn Schienenspieler hoch stehen und nicht zurücksprinten, entsteht seitliche Tiefe für den Gegner.',
        ...
        keyActions: [
          ...
          'Ballnaher Schienenspieler sprintet zurück und nimmt den gegnerischen Schienenspieler auf.',
          'Sechs bleibt vor der Kette und sichert zweite Bälle.',
      ...
      oppPossession: {
        spaces: [
          'Der äußere Innenverteidiger ist Pressingziel, weil wir dort Schienenspieler und Achter zustellen können.',
          'Zweite-Ball-Zonen vor beiden Dreierketten bleiben die Schlüsselräume.',
          'Außenbahnen hinter unseren Schienenspieler müssen gegen schnelle Verlagerungen geschützt werden.',
        ...
        advantages: [
          ...
          'Unsere Schienenspieler können direkte Gleichzahl herstellen und Druck nach außen lenken.',
        ],
        dangers: [
          ...
          'Wenn ihre Schienenspieler höher bleiben, können sie unsere Schienenspieler dauerhaft nach hinten drücken.',
        ],
        keyActions: [
          'Eine Spitze läuft an, die andere schließt den Rückpass.',
          'Mittelfeld schiebt mannorientiert auf die drei Zentrumsspieler.',
          'Schienenspieler stellt den gegnerischen Schienenspieler bei Zuspiel sofort nach außen.',
      ...
      afterGain: {
        spaces: [
          ...
          'Die Außenbahn hinter ihrem Schienenspieler ist nach Balleroberung der beste Temporaum.',
        ...
        advantages: [
          ...
          'Schienenspieler können mit dem zweiten Pass Breite und Tempo geben.',
        ],
        dangers: [
          ...
          'Bei zu frühem Schienenspieler-Start öffnen wir denselben Raum für den Rückkonter.',
        ],
        keyActions: [
          ...
          'Schienenspieler hält Breite und startet nach dem gesicherten ersten Pass.',
    ...
    adjustments: [
      ...
      'Bei eigener Führung Schienenspieler tiefer starten lassen und Konter über die ausweichende Spitze suchen.',
    ],
  },
  {
    id: '5-3-2_vs_5-4-1',
    ...
    phases: {
      ownPossession: {
        spaces: [
          ...
          'Schienenspieler können ihre äußeren Mittelfeldspieler zurückdrücken, wenn sie breit und früh anspielbar sind.',
        ...
        advantages: [
          ...
          'Schienenspieler können ihre äußeren Mittelfeldspieler zurückdrücken.',
        ],
        dangers: [
          ...
          'Wenn beide Schienenspieler gleichzeitig hoch stehen, fehlt Absicherung gegen den Zielspieler.',
      ...
      afterLoss: {
        spaces: [
          ...
          'Ballferne Seite hinter unserem Schienenspieler bleibt die gefährliche Entlastungsspur.',
        ...
        advantages: [
          ...
          'Ballferner Schienenspieler kann zur Absicherung tiefer bleiben, während die Ballseite presst.',
        ],
        dangers: [
          ...
          'Ein zweiter Ball auf den ballfernen Flügel kann unsere Schienenspieler in lange Rückwege zwingen.',
        ],
        keyActions: [
          'Nach Ballverlust Pass auf den Zielspieler verhindern.',
          'Zentrumsspieler sichern konsequent zweite Bälle.',
          'Ballferner Schienenspieler bleibt zur Absicherung tiefer.',
      ...
      oppPossession: {
        spaces: [
          ...
          'Ballferne Seite muss gegen lange Diagonalbälle durch den Schienenspieler gesichert werden.',
        ],
        advantages: [
        ...
        dangers: [
          'Wenn wir zu früh mit dem Schienenspieler springen, kann ihr äußerer Mittelfeldspieler in den Raum dahinter starten.',
        ...
        keyActions: [
          ...
          'Schienenspieler presst erst, wenn der Ball auf den Flügel kommt.',
          'Zentrumsspieler sichern konsequent zweite Bälle.',
          'Sechs nimmt Ablagen des Zielspielers vor der Fünferkette auf.',
          'Ballferner Schienenspieler bleibt eingerückt und schützt den zweiten Pfosten.',
        ],
      },
      afterGain: {
        spaces: [
        ...
        dangers: [
          ...
          'Wenn beide Schienenspieler starten, fehlt die Absicherung gegen ihren Zielspieler.',
        ...
        keyActions: [
          ...
          'Ballfernen Schienenspieler erst nach gesichertem ersten Pass aktivieren.',
    ...
    adjustments: [
      ...
      'Zentralen Innenverteidiger mutiger andribbeln lassen.',
      'Bei Kontergefahr nur einen Schienenspieler gleichzeitig hochschieben.',
    ],
  },
  {
    id: '5-3-2_vs_4-1-4-1',
    ...
    rating: 'ausgeglichen',
    character:
      'Ihre Fünfer-Mittelfeldstruktur kann unser Zentrum blockieren. Wir müssen den einzelnen Sechser binden und dann schnell über Schienenspieler oder diagonale Läufe lösen.',
    phases: {
      ownPossession: {
        spaces: [
          'Räume neben ihrem Sechser sind die wichtigsten Zwischenräume für unsere Achter.',
          'Außenbahnen hinter ihren Außenspielern öffnen sich nach diagonalen Verlagerungen auf den Schienenspieler.',
          'Der Rückraum vor ihrer Viererkette muss für Ablagen und zweite Bälle besetzt bleiben.',
          'Der ballferne Schienenspieler wird frei, wenn ihr Fünfermittelfeld zur Ballseite schiebt.',
        ...
        keyActions: [
          ...
          'Diagonal auf den ballfernen Schienenspieler verlagern.',
          'Achter in die Räume neben ihrem Sechser schieben.',
          'Schienenspieler auf der Ballseite höher positionieren, wenn ihr Außenspieler tief gebunden ist.',
      ...
      afterLoss: {
        spaces: [
          ...
          'Außenbahnen hinter unseren Schienenspieler sind offen, wenn ihre Außenspieler hoch bleiben.',
        ...
        dangers: [
          ...
          'Außenspieler können nach Ballgewinn direkt hinter unsere Schienenspieler starten.',
        ],
        keyActions: [
          ...
          'Schienenspieler sprintet zurück, wenn der ballnahe Außenspieler starten kann.',
        ],
      },
      oppPossession: {
        spaces: [
          ...
          'Verlagerungen auf ihre Außenspieler sind gefährlich, wenn unser Schienenspieler zu spät erkennt.',
        ],
        advantages: [
        ...
        dangers: [
          ...
          'Außenspieler können unsere Schienenspieler früh anlaufen und tief binden.',
        ...
        keyActions: [
          ...
          'Ballnaher Achter springt auf ihren Achter heraus.',
          'Schienenspieler bleibt wach gegen Verlagerungen.',
      ...
      afterGain: {
        spaces: [
          ...
          'Der ballferne Schienenspieler kann nach schnellem Diagonalball frei werden.',
        ...
        advantages: [
          ...
          'Schienenspieler können aus der Breite Tempo aufnehmen, bevor ihr 4-1-4-1 wieder kompakt ist.',
        ],
        dangers: [
          'Ein erster Pass in ihr kompaktes Zentrum läuft in den Zugriff von Sechs und Achtern.',
          'Wenn der Zielpass auf den Schienenspieler zu spät kommt, wird er von ihrem Außenspieler gestellt.',
        ...
        keyActions: [
          ...
          'Ballfernen Schienenspieler früh sehen, aber erst nach gesichertem erstem Pass anspielen.',
