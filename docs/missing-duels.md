...
Stand: 2026-05-15. Basis: `src/data/tacticBook/entries/*.ts` und `src/data/tacticBook/systems.ts`.
...
9 Systeme × 9 Gegner = **81 mögliche Duelle**. Aktuell erfasst: **17**. Offen: **64**.
...
Drei komplette Reihen leer: **4-4-2 (Raute)**, **3-4-3**, **4-1-4-1**.
...
### Unser System: 4-4-2 (Raute) — 9 offen
