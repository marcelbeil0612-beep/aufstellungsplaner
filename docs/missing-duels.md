...
Stand: 2026-05-15 (zuletzt aktualisiert nach Einpflege 4-4-2-raute · 6 Duelle).
...
9 Systeme × 9 Gegner = **81 mögliche Duelle**. Aktuell erfasst: **23**. Offen: **58**.
...
### Unser System: 4-4-2 (Raute) — 3 offen
