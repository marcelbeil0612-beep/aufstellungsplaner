...
Stand: 2026-05-15 (zuletzt aktualisiert nach Einpflege 4-4-2-raute · komplette Reihe).
...
9 Systeme × 9 Gegner = **81 mögliche Duelle**. Aktuell erfasst: **26**. Offen: **55**.
...
Erste komplett abgeschlossene Reihe: **4-4-2 (Raute)** 9/9. Zwei komplette Reihen noch leer: **3-4-3** und **4-1-4-1**.
