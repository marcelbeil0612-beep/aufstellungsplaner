...
Stand: 2026-05-15 (zuletzt aktualisiert nach Einpflege 3-4-3 · komplette Reihe).
...
9 Systeme × 9 Gegner = **81 mögliche Duelle**. Aktuell erfasst: **35**. Offen: **46**.
...
Komplett abgeschlossen: **4-4-2 (Raute)** 9/9, **3-4-3** 9/9. Eine komplette Reihe noch leer: **4-1-4-1**.
