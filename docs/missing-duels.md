...
Stand: 2026-05-15 (zuletzt aktualisiert nach Einpflege 3-4-3 · 6 Duelle).
...
9 Systeme × 9 Gegner = **81 mögliche Duelle**. Aktuell erfasst: **32**. Offen: **49**.
...
Komplett abgeschlossen: **4-4-2 (Raute)** 9/9. Eine komplette Reihe noch leer: **4-1-4-1**.
